  ...
  return (
    <div className="min-h-screen bg-white">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            <Card>
              <CardContent className="pt-6">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h4 className="font-semibold text-gray-900 mb-2">Easy Event Creation</h4>
            ...
            <Card>
              <CardContent className="pt-6">
                <div className="flex items-start gap-4">
                  <Users className="h-6 w-6 text-sky-600 flex-shrink-0 mt-1" />
                  <div>
                    <h4 className="font-semibold text-gray-900 mb-2">Attendee Management</h4>
                    <p className="text-sm text-gray-600">
            ...
            <Card>
              <CardContent className="pt-6">
                <div className="flex items-start gap-4">
                  <BarChart3 className="h-6 w-6 text-sky-600 flex-shrink-0 mt-1" />
                  <div>
            ...
            <Card>
              <CardContent className="pt-6">
                <div className="flex items-start gap-4">
                  <Calendar className="h-6 w-6 text-sky-600 flex-shrink-0 mt-1" />
                  <div>
            ...
            <Card>
              <CardContent className="pt-6">
                <div className="flex items-start gap-4">
                  <Check className="h-6 w-6 text-sky-600 flex-shrink-0 mt-1" />
                  <div>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        <div className="bg-sky-50 border border-sky-200 rounded-lg p-12 text-center">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2">
              ...
              <span className="font-semibold text-gray-900">EventMaster</span>
            </div>
            <p className="text-sm text-gray-500">© 2025 EventMaster. All rights reserved.</p>
          </div>
        </div>
      </footer>
    </div>
